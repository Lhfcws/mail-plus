 ...
 * @time 14-10-21.
 */
public class SMTPApacheMailSender implements SMTPSender {
    private static Log LOG = LogFactory.getLog(SMTPApacheMailSender.class);
    private org.apache.commons.mail.Email emailSender;
    private Email email;
    private MailUser mailUser;

    public SMTPApacheMailSender(Email email, MailUser mailUser) {
